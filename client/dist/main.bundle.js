  ...
  ;(e.n = (n) => {
    ...
    (() => {
      ...
      let b = {
        get(n, t, e) {
          if (n instanceof IDBTransaction) {
            if ("done" === t) return v.get(n)
            if ("objectStoreNames" === t) return n.objectStoreNames || g.get(n)
            if ("store" === t)
        ...
        return "function" == typeof n
          ? (t = n) !== IDBDatabase.prototype.transaction ||
            ...
            ? (
              ...
              ? function (...n) {
                  return t.apply(k(this), n), x(h.get(this))
                }
              : function (...n) {
                  return x(t.apply(k(this), n))
                }
            : function (n, ...e) {
                const r = t.call(k(this), n, ...e)
                return g.set(r, n.sort ? n.sort() : [n]), x(r)
              }
      ...
      function x(n) {
        if (n instanceof IDBRequest)
          return (function (n) {
            ...
            return (
              t
                .then((t) => {
                  t instanceof IDBCursor && h.set(t, n)
                })
                .catch(() => {}),
              y.set(t, n),
              t
        ...
        const t = w(n)
        return t !== n && (m.set(n, t), y.set(t, n)), t
      }
      const k = (n) => y.get(n)
      function E(
        n,
        ...
        return (
          r &&
            a.addEventListener("upgradeneeded", (n) => {
              r(x(a.result), n.oldVersion, n.newVersion, x(a.transaction))
            }),
        ...
        function b(n, t) {
          function r(o, i, a, c) {
            ...
            if ("throw" !== s.type) {
              var l = s.arg,
                f = l.value
              return f && "object" == P(f) && e.call(f, "__await")
          ...
          (n.mark = function (n) {
            return (
              Object.setPrototypeOf
                ...
                : ((n.__proto__ = p), c(n, a, "GeneratorFunction")),
      ...
      ;(M = b),
        (b = {
          ...M,
          get: (n, t, e) => I(n, t) || M.get(n, t, e),
          has: (n, t) => !!I(n, t) || M.has(n, t),
        })
      var B = (function () {
          var n = T(
            D().mark(function n() {
          ...
          ;(this.editor = CodeMirror(document.querySelector("#main"), {
            ...
            this.editor.on("blur", function () {
              console.log("The editor has lost focus"),
                C(localStorage.getItem("content"))
            })
        }),
        F = e(379),
        R = e.n(F),
