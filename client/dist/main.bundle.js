          ...
          new (class {
            constructor() {
              ...
              ;(this.editor = CodeMirror(document.querySelector("#main"), {
                ...
                (async () => {
                  const n = (await S("jate", 1))
                    .transaction("jate", "readonly")
                    .objectStore("jate")
                  let e = n.count(),
                    t = await e
                  return t ? await n.get(1)[0].value : t
                })().then((e) => {
                  console.info(
                ...
                this.editor.on("blur", () => {
                  console.log("The editor has lost focus"),
                    (async (n) => {
                      ...
                      const e = (await S("jate", 1))
                        .transaction("jate", readwrite)
                        .objectStore("jate")
                      let t = e.put({ id: 1, value: n }),
                        r = await t
                      r || ((t = e.add({ value: n })), (r = await t)),
                        console.log("Results saved", r)
